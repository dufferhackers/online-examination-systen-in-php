  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/sonu.jpg" width=100 height=100 alt="logo" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://ggi.ac.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">cse-3rd(b)</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917355643423</h4>
		<h4 style="font-family:'typo' ">ggi@gmail.com</h4>
