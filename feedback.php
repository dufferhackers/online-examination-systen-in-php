...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">CONTACT@GGI.AC.IN</a><br /><br />
...
<a href="http://www.ggi.ac.in">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Enginerds Group">
		 </div>
		 <div class="col-md-5">
		<a href="http://ggi.ac.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">CSE-3RD (B) /a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7355643423</h4>
            <h4 style="font-family:'typo' ">ggi.ac.in</h4>
            <h4 style="font-family:'typo' ">Gulzar Group Of Institutes Khanna</h4>
		</p>
      </div>
